...
const ChatComponent = () => {
  ...
  const historyContent =
    searchHistory.length > 0 ? (
      <ul className="list-group">{displaySearchHistory()}</ul>
    ) : (
    ...
    <div className="container" style={{ color: "black" }}>
      ...
      <div className="content">
        <div className="header">
          ...
          <p>
            Ask me about COVID-19 vaccination guidelines, record verification,
            and how blockchain technology enhances record security.
          </p>
        </div>
